...
public class HjsonppShaders{
    ...
    public static class HjsonppPlanetShader extends HjsonppLoadShader{
    ...
    public static class PlanetTextureShader extends HjsonppLoadShader{
    ...
    public static class HjsonppLoadShader extends Shader {

        public HjsonppLoadShader(String fragment, String vertex){
            super(
                    file(vertex + ".vert"),
                    file(fragment + ".frag")
            );
